...
export const getAllGenerations = async (req, res) => {
  try {
    // Find all generations and populate user info
    const generations = await imageModel.find({})
      .sort({ createdAt: -1 }) 
...
export default { generateImage, getUserGenerations, getGeneration, getAllGenerations };